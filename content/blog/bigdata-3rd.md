...
| title | description | slug | category | author |
|--|--|--|--|--|
| 3개월 간의 데이터 분석 프로젝트 정리하기 | 3개월 간 '교통•문화•통신 빅데이터 플랫폼 융합 분석 경진대회'에 참가한 것과 구글 데이터 스튜디오를 활용한 프로젝트 내용을 정리한다.  | bigdata-3rd | Data Analysis | 코코넛 팀 |
