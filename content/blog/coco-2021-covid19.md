...
![1. 분석 목적.PNG](static/coco-2021-covid19/1. 분석 목적.png)
...
![2. 사이버 범죄란.PNG](static/coco-2021-covid19/2. 사이버 범죄란.png)
...
![3. 데이터 선정.PNG](static/coco-2021-covid19/3. 데이터 선정.png)
...
![3. 데이터 선정_2.PNG](static/coco-2021-covid19/3. 데이터 선정_2.png)
...
- **뉴스 기사 크롤링 과정**
    ...
    정확하게 키워드와 일치한 검색 결과를 얻기 위해서는 `"쌍따옴표"`를 붙여야 합니다.
        ...
        ![뉴스기사크롤링과정1.PNG](static/coco-2021-covid19/뉴스기사크롤링과정1.PNG)

    1. 옵션에서 기간을 설정해줍니다.

        ![뉴스기사크롤링과정2.PNG](static/coco-2021-covid19/뉴스기사크롤링과정2.PNG)

    1. 해당 검색 결과의 마지막 페이지가 몇 페이지인지 확인해줍니다.

        ![뉴스기사크롤링과정3.PNG](static/coco-2021-covid19/뉴스기사크롤링과정3.PNG)

    1. 주소 창의 링크를 복사합니다.

        ![뉴스기사크롤링과정4.PNG](static/coco-2021-covid19/뉴스기사크롤링과정4.PNG)
...
![4-1. 코로나19 시대 전후 사이버 범죄 기사 수 비교.PNG](static/coco-2021-covid19/4-1. 코로나19 시대 전후 사이버 범죄 기사 수 비교.png)
...
![4-1. 코로나19 시대 전후 사이버 범죄 기사 수 비교_2.PNG](static/coco-2021-covid19/4-1. 코로나19 시대 전후 사이버 범죄 기사 수 비교_2.png)

"박수도 손뼉이 맞아야 칠 수 있듯, 범죄도 동기와 기회가 모두 있어야 일어난다"

따라서, 9월의 범죄 증가는 경제 악화로 생긴 범죄의 동기와 추석 연휴라는 기회가 맞아 떨어지면서 생긴 현상으로 볼 수 있습니다!!🤔

![4-1. 코로나19 시대 전후 사이버 범죄 기사 수 비교_3.PNG](static/coco-2021-covid19/4-1. 코로나19 시대 전후 사이버 범죄 기사 수 비교_3.png)
...
![4-2. 코로나 확진자 수와 사이버 범죄 기사 수의 관계.PNG](static/coco-2021-covid19/4-2. 코로나 확진자 수와 사이버 범죄 기사 수의 관계.png)
...
![4-3. 19,20년 사이버 범죄 기사 키워드 비교.PNG](static/coco-2021-covid19/4-3. 19,20년 사이버 범죄 기사 키워드 비교.png)
...
![코로나.PNG](static/coco-2021-covid19/코로나.png)
...
![카카오, 메신저.PNG](static/coco-2021-covid19/카카오, 메신저.png)
...
![AI.PNG](static/coco-2021-covid19/AI.png)
...
![개인정보.PNG](static/coco-2021-covid19/개인정보.png)
...
![5. 결론.PNG](static/coco-2021-covid19/5. 결론.png)
